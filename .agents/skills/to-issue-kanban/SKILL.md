...
> **Prerequisite:** `to-issues` ([mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/engineering/to-issues)) must be installed globally (`~/.agents/skills/to-issues/`). It is not vendored into this repo — see `.Codex/skills/README.md`.
