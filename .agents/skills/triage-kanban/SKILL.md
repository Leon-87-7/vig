...
> **Prerequisite:** `triage` ([mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/engineering/triage)) must be installed globally (`~/.agents/skills/triage/`). It is not vendored into this repo — see `.Codex/skills/README.md`.
